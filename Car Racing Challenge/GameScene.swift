...
class GameScene: SKScene
{
    ...
    func build()
    {
        ...
        */
        if(self.mainCharacter == nil)
        {
            ...
            self.scene?.backgroundColor = Colors.gamebg;
            //desenha a malha no context
            pixelsGridTexture = SKSpriteNode.init(color: Colors.gamebg, size: self.size)
            ...
            */
            self.mainCharacter = CustomSpriteNode(texture: SKTexture.init(image: Colors.carImageMain))
    ...
    fileprivate func addNewEnemy()
    {
        ...
        func createEnemy(_ col:CGFloat)
        {
            ...
            newEnemy = CustomSpriteNode(texture: SKTexture.init(image: Colors.carImageEnemy))
